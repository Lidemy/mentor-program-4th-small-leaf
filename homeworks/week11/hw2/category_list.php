<?php
  ...
  $sql = 'select * from small_leaf_blog_categories where is_deleted is null order by id';
      ...
      <div class="admin-posts">
        <?php
          while($row = $result->fetch_assoc()) { 
            $count = hasPostsCount(($row['id']));
        ?>
          <div class="admin-post">
            <div class="admin-post__title">
              <a href="category.php?category_id=<?php echo escape($row['id']) ?>"><?php echo escape($row['name']) ?>  ( <?php echo $count ?> )</a>
            </div>
